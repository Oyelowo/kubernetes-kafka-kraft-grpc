...
# from protobuf import location_pb2, location_pb2_grpc, connection_pb2, connection_pb2_grpc
...
# channel = grpc.insecure_channel(f"{api_location_host}:50051")
